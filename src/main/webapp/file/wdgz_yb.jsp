	...
	<table width="98%" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td height="41" background="../images/table/right-top-bg.jpg"><img
                    ...
                    align="absmiddle"><span class="txt-blue">我的工作&gt;&gt;已办</span></td>
		</tr>
	</table>
	<table width="98%" align="center" cellpadding="0" cellspacing="0">
		<tr>
					...
					<tr>
						<td><table width="100%" border="1" align="center"
								...
								<tr>
									...
									<td class="table-right-bottom-gray"><a href="#"
										class="txt-gray">中国移动集团新疆邮箱公司二级经理考核系统正式...</a></td>
									<td class="table-right-bottom-gray"><a href="#"
										class="txt-gray">admin-cc</a></td>
									<td class="table-bottom-gray"><span class="txt-gray">[2007-09-26]</span></td>
								</tr>
								<tr bgcolor="#E5EEFF">
									<td class="table-right-bottom-gray"><div align="center">
								...
								<tr>
									...
									<td class="table-right-bottom-gray"><a href="#"
										class="txt-gray">中国移动集团新疆邮箱公司二级经理考核系统正式...</a></td>
									<td class="table-right-bottom-gray"><a href="#"
										class="txt-gray">admin-asfdsgf</a></td>
									<td class="table-bottom-gray"><span class="txt-gray">[2007-09-26]</span></td>
								</tr>
								<tr bgcolor="#E5EEFF">
									<td class="table-right-bottom-gray"><div align="center">
									...
									<td class="table-right-bottom-gray"><a href="#"
										class="txt-gray">中国移动集团新疆邮箱公司二级经理考核系统正式...</a></td>
									<td class="table-right-bottom-gray"><a href="#"
										class="txt-gray">admin-safsd</a></td>
									<td class="table-bottom-gray"><span class="txt-gray">[2007-09-26]</span></td>
								</tr>
								<tr>
									<td class="table-right-bottom-gray"><div align="center">
								...
								<tr bgcolor="#E5EEFF">
									...
									<td class="table-right-bottom-gray"><a href="#"
										class="txt-gray">中国移动集团新疆邮箱公司二级经理考核系统正式...</a></td>
									<td class="table-right-bottom-gray"><a href="#"
										class="txt-gray">admin-vbfg</a></td>
									<td class="table-bottom-gray"><span class="txt-gray">[2007-09-26]</span></td>
								</tr>
								<tr>
									<td class="table-right-bottom-gray"><div align="center">
									...
									<td class="table-right-bottom-gray"><a href="#"
										class="txt-gray">中国移动集团新疆邮箱公司二级经理考核系统正式...</a></td>
									<td class="table-right-bottom-gray"><a href="#"
										class="txt-gray">admin-jlui</a></td>
									<td class="table-bottom-gray"><span class="txt-gray">[2007-09-26]</span></td>
								</tr>
								<tr bgcolor="#E5EEFF">
									<td class="table-right-bottom-gray">&nbsp;</td>
									<td class="table-right-bottom-gray">&nbsp;</td>
									<td class="table-right-bottom-gray">&nbsp;</td>
									<td class="table-bottom-gray">&nbsp;</td>
								</tr>
								<tr>
									<td class="table-right-bottom-gray">&nbsp;</td>
									<td class="table-right-bottom-gray">&nbsp;</td>
