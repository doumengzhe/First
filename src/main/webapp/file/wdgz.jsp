					...
					<tr>
									...
									<td width="186" height="33"
										background="images/button/left-menu-an-bg.jpg"><div
											...
											<img src="images/ico/left-menu-ico.gif" width="9" height="9"
												...
												href="getDocByAccount?accountid=${sessionScope.account.accountid}" target="Middle" class="txt-blue">待办</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										</div></td>
								</tr>
								<tr>
								...
								<c:if
									...
									<tr>
										<td height="33" background="images/button/left-menu-an-bg.jpg"><div
												...
												<img src="images/ico/left-menu-ico.gif" width="9" height="9"
													hspace="6" align="absmiddle"><a
													href="getCheckDocAndRealname?accountid=${account.accountid}" target="Middle" class="txt-blue">起草考核</a>&nbsp;&nbsp;
											</div></td>
									</tr>
								</c:if>
						...
						<td width="808" valign="top"><table width="100%"
								...
								<tr>
									<td>
										<div align="right">
											<iframe src="getDocByAccount?accountid=${sessionScope.account.accountid}" width="100%" marginwidth="0"
